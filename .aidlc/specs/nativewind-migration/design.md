...
**เหตุผลที่เลือกแบบนี้** (D3-1): NativeWind v4 ทำงานที่ babel + metro เท่านั้น ไม่มี native module ผลลัพธ์จึงยังเป็น JS bundle — **ยืนยันแล้วว่าส่งผ่าน OTA ได้จริง** (task 3.1/3.2, update group `70ce04e7`, 2026-09-24): แท็บเล็ตที่หน้างานรับ update แล้วเปิดแอพขึ้น เข้าสู่ระบบ สแกน และพิมพ์สลิปได้ตามปกติ **ไม่ต้อง build APK ใหม่**
...
| ~~**OTA ใช้ไม่ได้**~~ | ~~แผน deploy ทั้งหมดเปลี่ยน~~ | ✅ **ปิดแล้ว** — พิสูจน์ที่ task 3.2 เมื่อ 2026-09-24 |
