...
## Notes
- **ต่อ SUNMI V3 เข้ากับเครื่องพัฒนาผ่าน USB ได้** (ยืนยัน 2026-09-24) — ใช้ `adb` ดูแอพที่ติดตั้ง, runtime ที่ฝังใน APK, log ของ `dev.expo.updates` และจับหน้าจอได้ ถ้าขึ้น `unauthorized` ต้องกดอนุญาต USB debugging บนเครื่องก่อน
